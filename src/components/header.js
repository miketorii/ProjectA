  ...
  render() {
    return (
	  ...
	  <nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left App-w3-header" id="mySidebar">
	      <a href="javascript:void(0)" onClick={this.w3_close.bind(this)} class="w3-bar-item w3-button">Close Menu</a>
	  ...
	  <div class="w3-bar w3-black w3-wide w3-padding w3-card">
	      ...
	      <a href="#home" class="w3-bar-item w3-button"><b>Mars Project</b></a>
